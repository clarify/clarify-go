...
type dataQuery struct {
	Filter data.Filter `json:"filter,omitempty"`
...
// filter.
func (req DataFrameRequest) Filter(filter filter.Filter) DataFrameRequest {
...
// provided filter.
func (req DataFrameRequest) FilterField(path string, cmp filter.Comparison) DataFrameRequest {
...
func (req DataFrameRequest) TimeRange(gte, lt time.Time) DataFrameRequest {
	req.data.Filter.Times = data.TimeRange(gte, lt)
	return req
}
